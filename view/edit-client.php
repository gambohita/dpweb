            ...
            <form id="frm_edit_cliente" action="" method="">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-success btn-sm" id="btn_guardar_cambios"><i class="bi bi-check-circle"></i> Actualizar</button>
                        <a href="<?php echo BASE_URL; ?>cliente" class="btn btn-danger btn-sm"><i class="bi bi-x-circle"></i> Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
